...
exports.gradeCircuitSubmission = gradeCircuitSubmission;
 ...
 */
async function gradeCircuitSubmission(screenshotUrl, questionText, referenceAnswer, referenceImageUrl) {
    const apiKey = process.env.GEMINI_API_KEY;
    if (!apiKey || apiKey === 'your-gemini-api-key-here') {
        // Fallback: return a default score when no API key is configured
        return {
            score: 50,
            feedback: 'AI grading unavailable — API key not configured. This is a placeholder score. Please configure GEMINI_API_KEY for real grading.',
        };
    }
    try {
