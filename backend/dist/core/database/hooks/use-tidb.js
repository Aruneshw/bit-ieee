 ...
 *
 * Usage:
 *   import { useTiDB } from '@/core/database/hooks/use-tidb'
 *
 *   const tidb = useTiDB()
...
exports.useTiDB = useTiDB;
exports.tidbClient = tidbClient;
const react_1 = require("react");
class TiDBQueryBuilder {
    table;
    whereParams = {};
    orderByCol = null;
    orderDir = 'desc';
 ...
 */
function useTiDB() {
    const from = (0, react_1.useCallback)((table) => {
        return new TiDBQueryBuilder(table);
    }, []);
    return { from };
}
/**
...
function tidbClient() {
    return {
        from: (table) => new TiDBQueryBuilder(table),
    };
}
